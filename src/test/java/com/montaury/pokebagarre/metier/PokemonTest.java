...
class PokemonTest {
    ...
    void p1_devrait_gagner_quand_il_a_une_meilleure_attaque() {
        // GIVEN
        Pokemon p1 = unPokemon().avecAttaque(100).construire();
        Pokemon p2 = unPokemon().avecAttaque(80).construire();
    ...
    void p1_devrait_perdre_quand_le_pokemon_2_a_une_meilleure_attaque() {
        // GIVEN
        Pokemon p1 = unPokemon().avecAttaque(70).construire();
        Pokemon p2 = unPokemon().avecAttaque(90).construire();
    ...
    void p1_devrait_gagner_quand_les_attaques_sont_egales_mais_p1_a_une_meilleure_defense() {
        // GIVEN
        Pokemon p1 = unPokemon().avecAttaque(100).avecDefense(60).construire();
        Pokemon p2 = unPokemon().avecAttaque(100).avecDefense(40).construire();
    ...
    void p1_devrait_perdre_quand_les_attaques_sont_egales_mais_p2_a_une_meilleure_defense() {
        // GIVEN
        Pokemon p1 = unPokemon().avecAttaque(100).avecDefense(30).construire();
        Pokemon p2 = unPokemon().avecAttaque(100).avecDefense(50).construire();
    ...
    void p1_devrait_gagner_quand_les_attaques_et_les_defenses_sont_identiques(){
        // GIVEN
        Pokemon p1 = unPokemon().avecAttaque(100).avecDefense(50).construire();
        Pokemon p2 = unPokemon().avecAttaque(100).avecDefense(50).construire();
        // WHEN
        boolean resultat = p1.estVainqueurContre(p2);
        // THEN
